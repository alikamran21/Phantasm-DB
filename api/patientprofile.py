# api/patientprofile.py — Vercel Python Serverless Function
# api/health.py
...
async def _run(token, ip, ua):
    async with _SessionLocal() as db:
        ...
        return 200, {"id": user.identity_id, "mrn": pat.mrn if pat else None,
            ...
            "diagnosis": pat.diagnosis if pat else None, "medications": meds,
